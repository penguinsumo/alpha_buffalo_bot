...
# ============================================================
# 🆕 PHASE 2: SCALP_BE State Support
# ============================================================
# เพิ่ม state ใหม่: SCALP_BE_MANAGING
# State Flow: IDLE → SCALP_BE_ENTRY → SCALP_BE_MANAGING → EXIT

SCALP_BE_STATES = {
    'IDLE': 'SCALP_BE_ENTRY',
    'SCALP_BE_ENTRY': 'SCALP_BE_MANAGING',
    'SCALP_BE_MANAGING': 'EXIT',
    'EXIT': 'IDLE'
}

def get_scalp_be_transition(current_state: str, trigger: str) -> str:
    """State machine สำหรับ SCALP_BE"""
    if current_state == 'IDLE' and trigger == 'SCALP_BE_SIGNAL':
        return 'SCALP_BE_ENTRY'
    elif current_state == 'SCALP_BE_ENTRY' and trigger == 'ORDER_FILLED':
        return 'SCALP_BE_MANAGING'
    elif current_state == 'SCALP_BE_MANAGING' and trigger in ['TP_HIT', 'SL_HIT', 'BE_STOP', 'TRAIL_STOP', 'TIMEOUT']:
        return 'EXIT'
    elif current_state == 'EXIT' and trigger == 'RESET':
        return 'IDLE'
    return current_state

def is_scalp_be_state(state: str) -> bool:
    """เช็คว่าอยู่ใน SCALP_BE pipeline หรือไม่"""
    return state in ['SCALP_BE_ENTRY', 'SCALP_BE_MANAGING']
