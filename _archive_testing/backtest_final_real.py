#!/usr/bin/env python3
"""
FINAL BACKTEST: v11.2 vs New V4 (Real Data GC=F 60 days)
- Fix data loading (headers, numeric, lower case)
- Full comparison with session breakdown
"""
...
# ลบ Header ปลอม / แถวที่มีข้อความ 'Ticker', 'Datetime' ฯลฯ
df = df.reset_index()
# ถ้ามีคอลัมน์ชื่อ 'Ticker' ให้ลบออก
...
# เปลี่ยนชื่อคอลัมน์เป็น lower case
