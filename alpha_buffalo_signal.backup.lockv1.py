...
- Uses SignalDecision from signal_composer
...
from signal_composer import compose_signal, SignalDecision, safe_float
...
# ── Decision Validator ─────────────────────────────────
def validate_decision(decision: SignalDecision) -> bool:
